<template>
  <f7-page>
    <f7-navbar >
      <p style="margin-left:5px;"> <f7-link href="/info/" view="#main-view" to="/info/"><img :src="user.duongdanavatar" width="40px" height="40px" style="border-radius:50%"> {{fullName}}</f7-link></p>
    </f7-navbar>
    <f7-list>
